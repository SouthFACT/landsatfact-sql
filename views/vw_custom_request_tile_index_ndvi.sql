-- View: public.vw_custom_request_tile_index_ndvi

-- DROP VIEW public.vw_custom_request_tile_index_ndvi;

CREATE OR REPLACE VIEW public.vw_custom_request_tile_index_ndvi AS
 SELECT (SELECT path_data from lsf_enviroments) || '/ndvi/'::text || products.product_id::text AS location,
...
ALTER TABLE public.vw_custom_request_tile_index_ndvi
  OWNER TO root;
GRANT ALL ON TABLE public.vw_custom_request_tile_index_ndvi TO root;
GRANT SELECT ON TABLE public.vw_custom_request_tile_index_ndvi TO readonly;
GRANT ALL ON TABLE public.vw_custom_request_tile_index_ndvi TO dataonly;
