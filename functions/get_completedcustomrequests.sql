-- Function: public.get_completedcustomrequests()

-- DROP FUNCTION public.get_completedcustomrequests();

CREATE OR REPLACE FUNCTION public.get_completedcustomrequests()
  RETURNS SETOF custom_requests_pending AS
$BODY$

  --function to a table or list of completed.  emails have been set
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.get_completedcustomrequests()
  OWNER TO root;
GRANT EXECUTE ON FUNCTION public.get_completedcustomrequests() TO public;
GRANT EXECUTE ON FUNCTION public.get_completedcustomrequests() TO root;
GRANT EXECUTE ON FUNCTION public.get_completedcustomrequests() TO dataonly;
GRANT EXECUTE ON FUNCTION public.get_completedcustomrequests() TO readonly;
