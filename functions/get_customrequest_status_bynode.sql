-- Function: public.get_customrequest_status_bynode(varchar(25))

-- DROP FUNCTION public.get_customrequest_status_bynode(varchar(25));
...
$BODY$
  ...
  RETURN QUERY EXECUTE
   ...
   WHERE (SELECT ua.node_id FROM user_aoi as ua WHERE ua.aoi_id = cr_dates.aoi_id) = $1
  GROUP BY cr_dates.aoi_id, cr_dates.custom_request_status_id
  ORDER BY (SELECT ua.node_id FROM user_aoi as ua WHERE ua.aoi_id = cr_dates.aoi_id), cr_dates.custom_request_date' USING cr_node_id
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.get_customrequest_status_bynode(varchar(25))
  OWNER TO root;
GRANT EXECUTE ON FUNCTION public.get_customrequest_status_bynode(varchar(25)) TO public;
GRANT EXECUTE ON FUNCTION public.get_customrequest_status_bynode(varchar(25)) TO root;
GRANT EXECUTE ON FUNCTION public.get_customrequest_status_bynode(varchar(25)) TO dataonly;
GRANT EXECUTE ON FUNCTION public.get_customrequest_status_bynode(varchar(25)) TO readonly;
